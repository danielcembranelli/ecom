...
<option value="C" <? if($_SESSION[buscapropostaantiga][tipoProposta]=='C'){?>selected="selected"<? } ?>>Contrato</option>
 ...
 &nbsp;Proposta Nr. <input type="text" name="nrProposta" value="<?=$_SESSION[buscapropostaantiga][nrProposta]?>" class="quicksearch" /> Filtro de <input type="text" name="dtInicial" value="<?=$_SESSION[buscapropostaantiga][dtInicial]?>" class="quicksearch" /> até <input type="text" name="dtFinal" class="quicksearch" value="<?=$_SESSION[buscapropostaantiga][dtFinal]?>" /></td><td width="1"><img src="themes/admin_default/space.gif" width="4" height="1" /></td><td align="right" width="1"><table border="0" cellpadding="0" cellspacing="1" class="tborder"><tr><td class="navpageselected" nowrap><a onclick="javascript:document.users.submit();" href="#" title="Quick Search">Pesquisar</a></td>
...
//Paginação
$numreg = 80; // Quantos registros por página vai ser mostrado
...
<tr>
<td colspan="5" class="<?=$cor?>"><b>Endereço:</b> <?=$sU[ORC_LOCALOBRA]?><br />
