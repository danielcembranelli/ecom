<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=ate&_a=managerBriefing" title="Manager Briefing">Manager Briefing</a></span></td>
					</tr>
					<tr height="4">
...
<? if($_POST[step]=='1'){
$Data=date("Y-m-d");
$obsBriefing=nl2br($_POST[obsBriefing]);
$sqlIncluir = mysql_query("Insert into cadastro (`telaCadastro`,`idCategoria`, `nomeCadastro`, `cnpjCadastro`, `contatoCadastro`, `telefoneCadastro`, `emailCadastro`, `tipoCadastro`, `dtCadCadastro`) values ('C', '$_POST[idCategoria]',  '$_POST[nomeBriefing]', '$_POST[cnpjBriefing]', '$_POST[contatoBriefing]', '$_POST[telefoneBriefing]', '$_POST[emailBriefing]', '$_POST[tipoBriefing]', '$Data')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Briefing "<?=$_POST[nomeBriefing]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Briefings</td>
			</tr>
...
<td class="tabletitlerow" width="150" align="center" nowrap>&nbsp;Categoria</td>
...
<? 
$sqlUsuario = mysql_query("SELECT A.*, B.nomeCategoria FROM cadastro A inner join categoria B on (A.idCategoria=B.idCategoria) where telaCadastro = 'C' ORDER BY nomeCadastro") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=core&_a=edituser&userid=1461" title="Edit"><?=$sU[nomeCadastro]?></a></td>
<td colspan="" width="200" align="center" valign=""><a href="index.php?_m=core&_a=edituser&userid=1461" title="Edit"><?=$sU[cnpjCadastro]?></a></td>
<td colspan="" width="150" align="center" valign=""><?=$sU[nomeCategoria]?></td>
<td colspan="" width="80" align="center" valign=""><? if($sU[tipoCadastro]=='C'){ echo "Contrato"; } else { echo "Avulso"; }?></td>
<td colspan="" width="80" align="center" valign=""><? if($sU[statusCadastro]=='A'){ echo "Ativo"; } else { echo "Cancelado"; }?></td>
</tr>
<? } ?>
