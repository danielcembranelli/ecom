...
if (r==true)
  {
	window.location.replace("index.php?_m=downloads&_a=managerMotivoProposta&step=3&idOperadora="+valor)
  }
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=downloads&_a=managerMotivoProposta" title="Manager Motivo Cancelamento de Proposta">Manager Motivo Cancelamento de Proposta</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into motivo_proposta (`labelMp`) values ('$_POST[nomeOperadora]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Motivo de Cancelamento "<?=$_POST[nomeOperadora]?>" Cadastrado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlIncluir = mysql_query("Update motivo_proposta set `labelMp`='$_POST[nomeOperadora]' where idMp='$_POST[id]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Motivo de Cancelamento Salvo com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlEdita = mysql_query("SELECT idMp, labelMp FROM motivo_proposta where idMp  ='$_REQUEST[id]'") or die ("Could not connect to database: ".mysql_error());
...
<td class="tcat" width="100%" colspan="" align="left" nowrap>Edição de Motivo de Cancelamento</td>
</tr>
</thead>
...
<input type="hidden" name="_a" value="managerMotivoProposta"/>
...
<tr>
<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
<td class="tcat" width="100%" colspan="" align="left" nowrap>Cadastro de Motivo de Cancelamento</td>
</tr>
</thead>
<tbody><tr><td class="contenttableborder" colspan="2">
<table border="0" cellpadding="3" cellspacing="1" width="100%">
...
<thead>
			<tr>
			<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Motivo de Proposta</td>
			</tr>
...
<? 
$sqlUsuario = mysql_query("SELECT idMp, labelMp FROM motivo_proposta ORDER BY labelMp") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=downloads&_a=managerMotivoProposta&funcao=edit&id=<?=$sU[idMp]?>" title="Editar"><?=$sU[labelMp]?></a></td>
</tr>
<? } ?>
