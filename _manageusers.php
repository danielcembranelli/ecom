<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=core&_a=manageusers" title="Manager Usuário">Manager Usuário</a></span></td>
					</tr>
					<tr height="4">
...
<? if($_POST[step]=='1'){
$data = date("Y-m-d");
$sqlIncluir = mysql_query("Insert into usuarios (`nomeUsuario`,`emailUsuario`,`telefoneUsuario`,`loginUsuario`,`senhaUsuario`,`grupoUsuario`,`dtCadUsuario`) values ('$_POST[NomeUsuario]','$_POST[EmailUsuario]','$_POST[TelefoneUsuario]','$_POST[LoginUsuario]','$_POST[SenhaUsuario]','$_POST[idGrupo]','$data')") or die ("Could not connect to database: ".mysql_error());
$idUsuario = mysql_insert_id();
if($sqlIncluir){

for($i=0;$i<count($_POST[idItem]);$i++){
$var=$_POST[idItem][$i];

$sqlItem = mysql_query("Insert into unidades_usuario values ('','$var',$idUsuario)") or die ("Could not connect to database: ".mysql_error());
$var='';
}
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Usuário "<?=$_POST[LoginUsuario]?>" Cadastrado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlIncluir = mysql_query("Update usuarios set nomeUsuario='$_POST[NomeUsuario]', emailUsuario='$_POST[EmailUsuario]', telefoneUsuario='$_POST[TelefoneUsuario]', loginUsuario='$_POST[LoginUsuario]',senhaUsuario='$_POST[SenhaUsuario]', grupoUsuario='$_POST[idGrupo]', dtAltUsuario='$data' where idUsuario = $_POST[idUsuario]") or die ("Altera Dado: ".mysql_error());
if($sqlIncluir){

$apaga = mysql_query("Delete from unidades_usuario where idUsuario='$_POST[idUsuario]'");

for($i=0;$i<count($_POST[idItem]);$i++){
$var=$_POST[idItem][$i];

$sqlItem = mysql_query("Insert into unidades_usuario values ('','$var','$_POST[idUsuario]')") or die ("Cadastro Itens: ".mysql_error());
$var='';
}
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Usuário "<?=$_POST[LoginUsuario]?>" Alterado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<? 
$sqlUsuario = mysql_query("SELECT A.idUsuario,A.nomeUsuario, A.emailUsuario, A.dtLogUsuario, B.titGrupo
FROM usuarios A
INNER JOIN grupo B ON ( A.grupoUsuario = B.idGrupo ) 
ORDER BY A.nomeUsuario
");
...
<td colspan="" width="" align="" valign=""><img src="themes/admin_default/icon_user.gif" align="absmiddle" border="0" />&nbsp;<a href="index.php?_m=core&_a=edituser&userid=<?=$sU[idUsuario]?>" title="Edit"><?=$sU[nomeUsuario]?></a></td>
<td colspan="" width="200" align="center" valign=""><a href="index.php?_m=core&_a=edituser&userid=<?=$sU[idUsuario]?>" title="Edit"><?=$sU[emailUsuario]?></a></td>
<td colspan="" width="80" align="center" valign=""><?=$sU[idUsuario]?></td>
<td colspan="" width="150" align="center" valign=""><img src="themes/admin_default/icon_usergroupregistered.gif" border="0" /> <?=$sU[titGrupo]?></td>
