<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=form&_a=managerProduto" title="Manager Produto">Manager Produto</a></span></td>
					</tr>
					<tr height="4">
...
$_POST[valorProduto] = str_replace('.','',$_POST[valorProduto]);
$_POST[valorProduto] = str_replace(',','.',$_POST[valorProduto]);

$obsProduto=nl2br($_POST[obsProduto]);
$sqlIncluir = mysql_query("Insert into produto (`nomeProduto`,`obsProduto`,`valorProduto`,`tempoProduto`) values ('$_POST[nomeProduto]','$obsProduto','$_POST[valorProduto]','$_POST[tempoProduto]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Produto "<?=$_POST[nomeProduto]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Produtos</td>
			</tr>
...
<td class="tabletitlerow" width="100" align="" nowrap>Duração</td>
</tr>

<? 
$sqlUsuario = mysql_query("SELECT * FROM produto ORDER BY nomeProduto") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=core&_a=edituser&userid=1461" title="Edit"><?=$sU[nomeProduto]?></a></td>
<td colspan="" width="" align="" valign="">&nbsp;<?=$sU[tempoProduto]?></td>
</tr>
<? } ?>
