...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=downloads&_a=managerUsuario" title="Manager Usuário">Manager Usuário</a> &raquo; <a href="index.php?_m=downloads&amp;_a=editUsuario" title="Editar Usuário">Editar Usuário</a></span></td>
					</tr>
					<tr height="4">
...
<tr class="row2" title="" onMouseOver="" onMouseOut="" onClick="" id="" style="">
  ...
  <td width="" height="20" colspan="" align="left" valign="middle" class="row1"><select name="statusP" id="perfil">
    <option value="A" <? if($sU[statuspropostaUsuario]=='A'){?>selected="selected"<? } ?>>Aguardando Aprovação</option>
