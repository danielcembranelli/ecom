<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=downloads&_a=managerOperador" title="Manager Operador">Manager Operador</a></span></td>
					</tr>
					<tr height="4">
...
if($_POST[step]=='1'){
	...
	$preco1 = str_replace("R$ ","",$_POST[preco]);
	$preco1 = str_replace(".","",$preco1);
	$preco1 = str_replace(",",".",$preco1);
	
	//Data de Nascimento
	$insereFamilia = mysql_query("Insert into operadortipo (labelOt, valorOt) VALUES ('".$_POST[label]."','".$preco1."')") or die (mysql_error());
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Operador Cadastrado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<? if($_POST[step]=='2'){
	...
	$insereFamilia = mysql_query("Update operadortipo set labelOt='".$_POST[label]."', valorOt='".$preco1."' where idOt='".$_POST[id]."' Limit 1") or die (mysql_error());
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Operador Alterado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Operadores</td>
			</tr>
...
<td class="tabletitlerow" width="15%" align="center" nowrap>&nbsp;Preço</td>
</tr>

<? 
$sqlUsuario = mysql_query("SELECT idOt, labelOt, valorOt FROM operadortipo ORDER BY labelOt") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, '<?=$cor?>');">
<td colspan="" width="" valign=""><a href="index.php?_m=downloads&_a=editOperador&id=<?=$sU[idOt]?>" title="Editar"><?=$sU[labelOt]?></a></td>
<td colspan="" align="center">R$ <?=number_format($sU[valorOt], 2, ',', '')?></td>
</tr>
<? } ?>
