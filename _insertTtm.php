...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=teamwork&_a=managerTtm" title="Manager Família Preço">Manager Modelo</a> &raquo; Novo Modelo</span></td>
					</tr>
					<tr height="4">
...
?>
      <option value="<?=$sU[id]?>"><?=$sU[nome]?></option>
      <? }?>
    </select></td>
</tr>
...
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="nome" value="" size="30" style="width:90%;" /></td>
</tr>
