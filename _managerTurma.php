<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=teamwork&_a=managerTurma" title="Manager Turma">Manager Turma</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into cursos_data (`idCurso`,`labelData`, `localData`, `dtData`, `valorData`, `statusData`) values ('$_POST[idCurso]','$_POST[labelData]', '$_POST[localData]', '$Data', '$Valor', '$_POST[status]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Turma "<?=$_POST[Data]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlIncluir = mysql_query("Update cursos_data set `idCurso`='$_POST[idCurso]',`labelData`='$_POST[labelData]', `localData`='$_POST[localData]', `dtData`='$Data', `valorData`='$Valor', `statusData`='$_POST[status]' where idData='$_POST[idData]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Turma "<?=$_POST[titulo]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Turmas</td>
			</tr>
			</thead><tbody><tr><td class="contenttableborder" colspan="2"><table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr>
<td class="tabletitlerow" width="200" align="center" nowrap>&nbsp;Data</td>
...
<? 
$sqlUsuario = mysql_query("SELECT A.*, DATE_FORMAT(dtData , '%d/%m/%Y') as dt, C.nomeCurso FROM cursos_data A inner join cursos C on (C.idCurso=A.idCurso) ORDER BY dtData desc") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=teamwork&_a=editTurma&id=<?=$sU[idData]?>" title="Editar"><?=$sU[dt]?></a></td>
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=teamwork&_a=editTurma&id=<?=$sU[idData]?>" title="Editar"><?=$sU[nomeCurso]?></a></td>
<td colspan="" width="80" align="center" valign=""><? if($sU[statusData]=='1'){ echo "Aberta"; } elseif($sU[statusData]=='2'){ echo "Esgotada"; }else { echo "Concluida"; }?></td>
</tr>
<? } ?>
