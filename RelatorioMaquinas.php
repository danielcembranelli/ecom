...
<td class="tabletitlerow" width="5%" align="center" nowrap>&nbsp;Marca</td>
...
<td class="tabletitlerow" width="5%" align="center" nowrap>&nbsp;Potência</td>
<td class="tabletitlerow" width="5%" align="center" nowrap>&nbsp;Operador</td>
</tr>

<? 
$sqlUsuario = mysql_query("SELECT A.potenciaFamilia, o.labelOt, id, nome,grupo, L.nomeLegenda as nome1, L2.nomeLegenda as marca, L1.nomeLegenda as categoria, L3.nomeLegenda as modelo, A.consumoFamilia, A.seguroFamilia, A.idOt FROM familia A LEFT JOIN legendas L ON ( A.nomeid = L.idLegenda) LEFT JOIN legendas L1 ON ( A.categoriaid = L1.idLegenda) LEFT JOIN legendas L2 ON ( A.marcaid = L2.idLegenda) LEFT JOIN legendas L3 ON ( A.modeloid = L3.idLegenda) left join operadortipo o on(o.idOt=A.idOt) where A.statusFamilia='A' ORDER BY nome1, marca, categoria, modelo") or die ("Could not connect to database: ".mysql_error());
...
<td colspan="" align="center"><?=$sU[potenciaFamilia];?></td>
<td colspan="" align="center"><?=$sU[labelOt];?></td>
