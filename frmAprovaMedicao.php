...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap><?=utf8_decode('Aprovar Medição');?></td>
			</tr>
...
<?
	$Sql = mysql_query("SELECT idContato, nomeContato, cargoContato FROM contatos c where idCliente='".$M[idCliente]."' And statusContato='A' order by nomeContato") or die (mysql_error());
...
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" style="">
  <td align="left" valign="top" colspan=""><span class="tabletitle"><?=utf8_decode('Data Emissão NF')?></span></td>
  <td align="left" valign="top" colspan=""><input name="dtnotafiscal" type="text" class="swifttext" value="<?=$M[dtnotafiscal]?>" alt="data2" size="12" maxlength="10" /></td>
</tr>
...
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle"><?=utf8_decode('Filial')?></span></td>
...
<tr>
    ...
    <center><input type="submit" name="submitbutton" class="yellowbuttonbigbig" value="Enviar" onclick="EnviaEmail();" />&nbsp;&nbsp;<input type="button" name="submitbutton" class="yellowbuttonbigbig" value="Cancelar" id="cancelar" /></center>
    </td>
</tr>
</tbody>
</table>
