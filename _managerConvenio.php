...
if (r==true)
  {
	window.location.replace("index.php?_m=teamwork&_a=managerConvenio&step=3&idOperadora="+valor)
  }
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=teamwork&_a=managerConvenio" title="Manager Convenio">Manager Convênio</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into operadora (`nomeOperadora`) values ('$_POST[nomeOperadora]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Convênio "<?=$_POST[nomeOperadora]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlIncluir = mysql_query("Update operadora set `nomeOperadora`='$_POST[nomeOperadora]' where idOperadora='$_POST[idOperadora]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Convenio "<?=$_POST[nomeOperadora]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>

<? if($_REQUEST[step]=='3'){

$sqlIncluir = mysql_query("Delete from operadora where idOperadora='$_REQUEST[idOperadora]' Limit 1") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Convênio Excluido com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlEdita = mysql_query("SELECT idOperadora, nomeOperadora FROM operadora where idOperadora ='$_REQUEST[id]' ORDER BY nomeOperadora") or die ("Could not connect to database: ".mysql_error());
...
<td class="tcat" width="100%" colspan="" align="left" nowrap>Edição de Convênio</td>
</tr>
</thead>
...
<td align="left" valign="top" colspan="">
 <input type="text" class="swifttext" name="nomeOperadora" id="titulomenu" value="<?=$sE[nomeOperadora]?>" size="30" /></td>
</tr>
...
<input type="hidden" name="idOperadora" value="<?=$sE[idOperadora]?>"/>
<input type="hidden" name="_m" value="teamwork"/>
<input type="hidden" name="_a" value="managerConvenio"/>
...
<tr>
<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
<td class="tcat" width="100%" colspan="" align="left" nowrap>Cadastro de Convênio</td>
</tr>
</thead>
<tbody><tr><td class="contenttableborder" colspan="2">
<table border="0" cellpadding="3" cellspacing="1" width="100%">
...
<thead>
			<tr>
			<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Convênios</td>
			</tr>
...
<? 
$sqlUsuario = mysql_query("SELECT idOperadora, nomeOperadora FROM operadora ORDER BY nomeOperadora") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td align="center"><a href="javascript:ConfirmaDel('<?=$sU[idOperadora]?>');" title="Apagar"><img src="themes/admin_default/action_delete.gif" border="0"></a></td>
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=teamwork&_a=managerConvenio&funcao=edit&id=<?=$sU[idOperadora]?>" title="Editar"><?=$sU[nomeOperadora]?></a></td>
</tr>
<? } ?>
