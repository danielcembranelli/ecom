...
if (r==true)
  {
	window.location.replace("index.php?_m=downloads&_a=managerGrupoContato&step=3&idOperadora="+valor)
  }
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=downloads&_a=managerGrupoContato" title="Manager Grupo de Contato de Cliente">Manager Grupo de Contato de Cliente</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into contatos_grupo (`labelCg`) values ('$_POST[nomeOperadora]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Grupo de Contato "<?=$_POST[nomeOperadora]?>" Cadastrado com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlIncluir = mysql_query("Update contatos_grupo set `labelCg`='$_POST[nomeOperadora]' where idCg='$_POST[id]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Grupode Contato Salvo com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlEdita = mysql_query("SELECT idCg, labelCg FROM contatos_grupo where idCg  ='$_REQUEST[id]'") or die ("Could not connect to database: ".mysql_error());
...
<td class="tcat" width="100%" colspan="" align="left" nowrap>Edição de Grupo de Contato de Cliente</td>
</tr>
</thead>
...
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="nomeOperadora" value="<?=$sE[labelCg]?>" size="30" /></td>
</tr>
...
<input type="hidden" name="id" value="<?=$sE[idCg]?>"/>
<input type="hidden" name="_m" value="downloads"/>
<input type="hidden" name="_a" value="managerGrupoContato"/>
...
<tr>
<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
<td class="tcat" width="100%" colspan="" align="left" nowrap>Cadastro de Grupo de Contato de Cliente</td>
</tr>
</thead>
<tbody><tr><td class="contenttableborder" colspan="2">
<table border="0" cellpadding="3" cellspacing="1" width="100%">
...
<? 
$sqlUsuario = mysql_query("SELECT idCg, labelCg FROM contatos_grupo ORDER BY labelCg") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, '<?=$cor?>');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=downloads&_a=managerGrupoContato&funcao=edit&id=<?=$sU[idCg]?>" title="Editar"><?=$sU[labelCg]?></a></td>
</tr>
<? } ?>
