...
if (r==true)
  {
	window.location.replace("index.php?_m=downloads&_a=managerParametro&step=3&idOperadora="+valor)
  }
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=downloads&_a=managerParametro" title="Manager Parâmetro">Manager Parâmetro</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into parametro (`labelParametro`) values ('$_POST[nomeOperadora]')") or die (mysql_error());
if($sqlIncluir){
?>
...
$sqlIncluir = mysql_query("Update parametro set `valorParametro`='$Valor' where idParametro='$_POST[id]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Parâmetro Salvo com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlEdita = mysql_query("SELECT idParametro, nomeParametro, valorParametro FROM parametro where idParametro  ='$_REQUEST[id]'") or die ("Could not connect to database: ".mysql_error());
...
<td class="tcat" width="100%" colspan="" align="left" nowrap>Edição de Parâmetro</td>
</tr>
</thead>
...
<td align="left" valign="top" colspan=""><?=$sE[nomeParametro]?></td>
</tr>
...
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="valor" id="valor" value="<?=str_replace('',',',$sE[valorParametro])?>" size="30" /></td>
</tr>
...
<input type="hidden" name="id" value="<?=$sE[idParametro]?>"/>
<input type="hidden" name="_m" value="downloads"/>
<input type="hidden" name="_a" value="managerParametro"/>
...
<thead>
			<tr>
			<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Parâmetro</td>
			</tr>
...
<? 
$sqlUsuario = mysql_query("SELECT idParametro, nomeParametro FROM parametro ORDER BY nomeParametro") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=downloads&_a=managerParametro&funcao=edit&id=<?=$sU[idParametro]?>" title="Editar"><?=$sU[nomeParametro]?></a></td>
</tr>
<? } ?>
