...
<form name="frmObra" id="downloadfileteamwork" action="index.php" method="POST" enctype="multipart/form-data">
...
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" style="">
  ...
  <td align="left" valign="top" colspan=""><input name="dtinicio" type="text" class="swifttext" value="" alt="data2" size="12" maxlength="10" /> a <input name="dtfinal" type="text" class="swifttext" alt="data2" value="" size="12" maxlength="10" onblur="FiltraPeriodo()" /> &nbsp; <input type="button" name="submitbutton" class="yellowbutton" value="Buscar" onclick="FiltraPeriodo();" /></td>
</tr>
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan=""><span class="tabletitle">Equipamento</span></td>
<td align="left" valign="top" colspan=""><select name="idEo" id="idEo">
<option>Selecione o codigo</option>
</select></td>
</tr>
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan=""><span class="tabletitle">Preço Equipamento</span></td>
<td align="left" valign="top" colspan=""><select name="idPe" id="idPe">
...
<br />
<center><input type="button" name="submitbutton" class="yellowbuttonbigbig" value="Carregar" onclick="FichaPeriodoEqpto()" /></center>
