<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=form&_a=managerDepartamento" title="Manager Departamento">Manager Departamento</a></span></td>
					</tr>
					<tr height="4">
...
<? if($_POST[step]=='1'){
$Data=date("Y-m-d");
$obsDepartamento=nl2br($_POST[obsDepartamento]);
$sqlIncluir = mysql_query("Insert into departamento (`nomeDepartamento`,`obsDepartamento`) values ('$_POST[nomeDepartamento]','$obsDepartamento')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Departamento "<?=$_POST[nomeDepartamento]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Departamentos</td>
			</tr>
...
<? 
$sqlUsuario = mysql_query("SELECT * FROM departamento ORDER BY nomeDepartamento") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=core&_a=edituser&userid=1461" title="Edit"><?=$sU[nomeDepartamento]?></a></td>
</tr>
<? } ?>
