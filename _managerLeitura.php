<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;<a href="index.php?_m=livesupport&_a=managerLeitura" title="Manager Leitura">Manager Leitura</a></span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into leitura (`tipoLeitura`,`tituloLeitura`, `descLeitura`, `htmlLeitura`, `imgLeitura`, `urlLeitura`, `statusLeitura`) values ('$_POST[tipo]', '$_POST[titulo]', '$_POST[textarea]', '$Html', '$_POST[imagem]', '$_POST[url]', '$_POST[status]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Leitura "<?=$_POST[titulo]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$_POST[textarea] = nl2br($_POST[textarea]);
$Html = str_replace('"','',$_POST[FCKeditor1]);
$sqlIncluir = mysql_query("Update leitura set `tipoLeitura`='$_POST[tipo]',`tituloLeitura`='$_POST[titulo]', `descLeitura`='$_POST[textarea]', `htmlLeitura`='$Html', `imgLeitura`='$_POST[imagem]', `urlLeitura`='$_POST[url]', `statusLeitura`='$_POST[status]' where idLeitura = '$_POST[idLeitura]") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Leitura "<?=$_POST[titulo]?>" Alterada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>

						<livesupport name="users" id="users" action="index.php" method="POST">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td><table width="100%"  border="0" cellspacing="0" cellpadding="0" style="display:none"><tr valign="top"><td align="left"><table border="0" cellpadding="0" cellspacing="1" class="tborder"><tr><td class="highlightpage">Página 1 de 1</td>
 <td class='navpageselected'><a href='index.php?_m=livesupport&_a=manageusers&offset=0' title='Page 1 of 2'>1</a></td>
<td class='navpage'><a href='index.php?_m=livesupport&_a=manageusers&offset=100' title='Page 2 of 2'>2</a></td>
<td class='navpage'><a href='index.php?_m=livesupport&_a=manageusers&offset=100'>&gt;</a></td>
...
<tr style="height: 1em"><td align="left"><div id="tab_massaction" style="DISPLAY: none;" class="tabcontent"><table border="0" cellpadding="3" cellspacing="1" width="100%" class="tborder"><tr class="row1"><td align="left" width="60">Action: </td><td align="left"><select name="mass_action" onChange="javascript:return dolivesupportConfirm('Are you sure you wish to continue?', this);" class="swiftselect"><option name="firstselect" value="">- Select -</option>
...
<thead>
			...
			<td class="tcat" width="100%" colspan="" align="left" nowrap>Lista de Leituras</td>
			</tr>
			</thead><tbody><tr><td class="contenttableborder" colspan="2"><table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr>
<td class="tabletitlerow" width="200" align="center" nowrap>&nbsp;Tipo</td>
...
<? 
$sqlUsuario = mysql_query("SELECT A.* FROM leitura A ORDER BY tituloLeitura") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, 'row2');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=livesupport&_a=editLeitura&id=<?=$sU[idLeitura]?>" title="Editar"><?
$r='';
switch($sU[tipoLeitura]){
case 'A': $r = 'Artigo';break;
case 'L': $r = 'Livro';break;
case 'F': $r = 'Filme';break;
case 'R': $r = 'Resenhas';break;
case 'N': $r = 'Noticia';break;
}
echo $r;
?></a></td>
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=livesupport&_a=editLeitura&id=<?=$sU[idLeitura]?>" title="Editar"><?=$sU[tituloLeitura]?></a></td>
<td colspan="" width="80" align="center" valign=""><? if($sU[statusLeitura]=='P'){ echo "Publicado"; } elseif($sU[statusPag]=='A'){ echo "Arquivado"; }else { echo "Rascunho"; }?></td>
</tr>
<? } ?>
