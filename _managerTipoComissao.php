...
if (r==true)
  {
	window.location.replace("index.php?_m=downloads&_a=managerTipoComissao&step=3&idOperadora="+valor)
  }
}
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="100%"><span class="smalltext">&nbsp;Manager Comissões</span></td>
					</tr>
					<tr height="4">
...
$sqlIncluir = mysql_query("Insert into comissao_tipo (nomeCt, pcpadraoCt, pcmaiorCt, pinf1Ct, pinf2Ct, pcmedioCt, pmenorCt, pcmenorCt) values ('$_POST[nomeCt]', '$_POST[pcpadraoCt]', '$_POST[pcmaiorCt]', '$_POST[pinf1Ct]','$_POST[pinf2Ct]','$_POST[pcmedioCt]','$_POST[pmenorCt]', '$_POST[pcmenorCt]')") or die (mysql_error());
if($sqlIncluir){
?>
...
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Comissão "<?=$_POST[nomeCt]?>" Cadastrada com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>

<? if($_POST[step]=='2'){
$sqlIncluir = mysql_query("Update comissao_tipo set nomeCt='$_POST[nomeCt]', pcpadraoCt='$_POST[pcpadraoCt]', pcmaiorCt='$_POST[pcmaiorCt]', pinf1Ct='$_POST[pinf1Ct]', pinf2Ct='$_POST[pinf2Ct]', pcmedioCt='$_POST[pcmedioCt]', pmenorCt='$_POST[pmenorCt]', pcmenorCt='$_POST[pcmenorCt]' where idCt='$_POST[id]'") or die (mysql_error());
if($sqlIncluir){
?>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
<tr><td width="16" align="left" valign="middle"><img src="themes/admin_default/icon_info.gif" border="0" /></td><td align="left"><span class="smalltext">Comissão Salva com Sucesso</span></td></tr></table></td></tr></tbody></table><BR />
<? }
} ?>
...
$sqlEdita = mysql_query("SELECT * FROM comissao_tipo where idCt='$_REQUEST[id]'") or die ("Could not connect to database: ".mysql_error());
...
<td class="tcat" width="100%" colspan="" align="left" nowrap>Edição de Comissão</td>
</tr>
</thead>
...
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="nomeCt" value="<?=$sE[nomeCt]?>" size="30" /></td>
</tr>

<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">% Padrão</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pcpadraoCt" alt="integer" value="<?=$sE[pcpadraoCt]?>" size="20" /></td>
</tr>
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">% Maior</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pcmaiorCt" alt="integer"  value="<?=$sE[pcmaiorCt]?>" size="20" /></td>
</tr>
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">Desconto Entre </span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pinf1Ct" alt="integer"  value="<?=$sE[pinf1Ct]?>" size="10" /> e <input type="text" class="swifttext" name="pinf2Ct" alt="integer"  value="<?=$sE[pinf2Ct]?>" size="10" /></td>
</tr>
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">% Média</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pcmedioCt" alt="integer"  value="<?=$sE[pcmedioCt]?>" size="20" /></td>
</tr>
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">Desconto Menor</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pmenorCt" alt="integer"  value="<?=$sE[pmenorCt]?>" size="20" /></td>
</tr>
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">% Menor</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pcmenorCt" alt="integer"  value="<?=$sE[pcmenorCt]?>" size="20" /></td>
</tr>
...
<input type="hidden" name="id" value="<?=$sE[idCt]?>"/>
<input type="hidden" name="_m" value="downloads"/>
<input type="hidden" name="_a" value="managerTipoComissao"/>
...
<tr>
<td class="tcat" width="1" align="left" nowrap><img src="themes/admin_default/space.gif" width="4" height="21"></td>
<td class="tcat" width="100%" colspan="" align="left" nowrap>Cadastro de Comissão</td>
</tr>
</thead>
<tbody><tr><td class="contenttableborder" colspan="2">
<table border="0" cellpadding="3" cellspacing="1" width="100%">
...
<tr class="row2" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">Desconto Menor</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pmenorCt" alt="integer"  value="<?=$sE[pmenorCt]?>" size="30" /></td>
</tr>
<tr class="row1" title="" onmouseover="" onmouseout="" onclick="" id="" style="">
<td align="left" valign="top" colspan="" width="50%"><span class="tabletitle">% Menor</span></td>
<td align="left" valign="top" colspan="" width="50%"><input type="text" class="swifttext" name="pcmenorCt" alt="integer"  value="<?=$sE[pcmenorCt]?>" size="20" /></td>
...
<? 
$sqlUsuario = mysql_query("SELECT idCt, nomeCt FROM comissao_tipo ORDER BY nomeCt") or die ("Could not connect to database: ".mysql_error());
while ($sU = mysql_fetch_array($sqlUsuario)){
$cor = ($coralternada++ %2 ? "row2" : "row1");  
?>
<tr id="trid1466" class="<?=$cor?>" onmouseover="showHighlight(this);" onmouseout="clearHighlight(this, '<?=$cor?>');">
<td colspan="" width="" align="" valign="">&nbsp;<a href="index.php?_m=downloads&_a=managerTipoComissao&funcao=edit&id=<?=$sU[idCt]?>" title="Editar"><?=$sU[nomeCt]?></a></td>
</tr>
<? } ?>
